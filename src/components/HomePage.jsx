...
export function HomePage(){
    ...
    return(
        <Container>
            ...
            <Content>
                <Carousel autoplay>
                    <img src="https://via.placeholder.com/600x250/8f8e94/FFFFFF?text=1" alt="" height="250" />
                    <img src="https://via.placeholder.com/600x250/8f8e94/FFFFFF?text=2" alt="" height="250" />
                    <img src="https://via.placeholder.com/600x250/8f8e94/FFFFFF?text=3" alt="" height="250" />
                    <img src="https://via.placeholder.com/600x250/8f8e94/FFFFFF?text=4" alt="" height="250" />
                    <img src="https://via.placeholder.com/600x250/8f8e94/FFFFFF?text=5" alt="" height="250" />
                </Carousel>
                <Divider />
